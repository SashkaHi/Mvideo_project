    ...
    return (
        <div className="all_header">
            ...
            <div className="main_header" style={divStyle}>
                <div className="pic">
                    <img style={divStyle} src={mvideo} alt=""/>
                    ...
                    <button className="btn_input" disabled={undefined}><IoIosSearch style={{backgroundColor: "#E21235"}}/></button>
                    <button className="btn_status"><WiTime9 style={{backgroundColor: "white"}}/><br/>Статус заказа</button>
                    <button className="btn_entrance"><GoPerson style={{backgroundColor: "white"}}/><br/>Войти</button>
                    <button className="btn_comparison"><GiHistogram style={{backgroundColor: "white"}}/><br/>Сравнение</button>
                    <button className="btn_favorites"><FaRegHeart style={{backgroundColor: "white"}}/><br/>Избранное</button>
                    <button className="btn_basket"><SlBasket style={{backgroundColor: "white"}}/><br/>Корзина</button>
